        ...
        <>
            ...
            <div class="mt-20 flex items-center justify-center">
                ...
                <div class="bg-white p-16 rounded shadow-2xl lg:w-2/3 sm:w-5/6">
                    ...
                    <form class="space-y-5" onSubmit={sendotp}>
                        ...
                        <button type='submit' class="block w-full bg-yellow-400 hover:bg-yellow-500 p-4 rounded text-white transition duration-300" >
                            {/* {btnloading ? <i className="fa fa-refresh fa-spin" style={{ marginRight: "5px" }} /> : null} Sign Up */}Register
                        </button>
                    ...
                    <div class="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                        Already have an account ? <Link to='/' class="cursor-pointer text-gray-600 hover:text-gray-800">Sign in</Link>
                    </div>
                ...
                <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 mt-0 opacity-0 ease-out transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
                    <div class="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
                                        ...
                                        <div class="w-full">
                                            <div class="bg-white h-64 py-3 rounded text-center">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="number" value={otp} onChange={e => setotp(e.target.value)} name="otp" style={{ width: '8cm' }} class="border-2 border-gray-200 p-3 rounded outline-none focus:border-yellow-500" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="flex justify-end items-center gap-x-2 py-3 px-4 border-t dark:border-gray-700">
                            ...
                            <button class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-yellow-500 text-white hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800" href="#">
                                Register
                            </button>
                        </div>
                    </div>
